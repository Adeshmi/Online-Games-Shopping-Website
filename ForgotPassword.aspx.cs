    ...
    protected void btPassRec_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody = "Hi "+Username+ ",<br/><br/> Click the link below to reset your password <br/><br/> http://localhost:5772/RecoverPassword.aspx?Uid="+myGUID;
                MailMessage PassRecMail = new MailMessage("adeshingale66@gmail.com", ToEmailAddress);
                PassRecMail.Body = EmailBody;
                PassRecMail.IsBodyHtml = true;
                PassRecMail.Subject = "Reset Password";

                //SmtpClient SMTP = new SmtpClient("pop.gmail.com", 995);
                SmtpClient SMTP = new SmtpClient("pop.gmail.com");
                SMTP.Port = 995;
                SMTP.Credentials = new NetworkCredential()
                {
                    UserName = "adeshingale66@gmail.com",
                    Password = "Adeshmi1999"
                };
                SMTP.EnableSsl = true;
